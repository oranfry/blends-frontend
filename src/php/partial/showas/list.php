...
<table class="easy-table">
    <thead>
        <tr>
            <th class="when-selecting printhide"><i class="icon icon--smallsquare selectall"></i></td></th>
            ...
            <?php if (@$groupfield && @$record->{$groupfield} != $lastgroup): ?>
                ...
                <?php if (@$record->{$groupfield}): ?>
                    ...
                    <tr class="<?= strcmp($record->{$groupfield}, @$currentgroup) ? '' : 'today' ?>">
                        <td class="when-selecting printhide"><i class="icon icon--smallsquare selectall"></i></td>
                        <?php
